...
// Its glyph box is 19.2×18.79, so it sits a touch lower than the square ones.
// The set draws it pointing right; a cursor has to point where the hand comes
// from, so it is mirrored.
export const SelectIcon = ({ className }: IconProps) => (
  <Glyph
    d="M8.86323 12.3988L11.0969 18.8596C11.5156 20.0706 13.2135 20.1111 13.6894 18.9214L20.0976 2.90324C20.5434 1.78891 19.4562 0.674263 18.3311 1.09213L1.90196 7.194C0.701371 7.6399 0.698694 9.33708 1.89787 9.78677L8.86323 12.3988Z"
    className={className}
    at="1.4 1.6064"
    flip
  />
